...
const StyledOffCanvas = styled.nav`
  ${tw`bg-secondary-900 border-t border-white fixed top-0 left-0 w-full h-screen pt-10 pb-40 px-10 z-10 overflow-y-scroll transition-transform duration-500 ease-in-out`}
