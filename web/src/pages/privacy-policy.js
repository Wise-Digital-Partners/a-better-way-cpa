      ...
      <section className="pt-12 md:pt-16 pb-20 md:pb-30">
        <div className="container">
          ...
          <p>
            ...
            of Privacy applies to https://www.e3mortgage.com/, and Dark Horse
            CPAs and governs data collection and usage. For the purposes of this
            Privacy Policy, unless otherwise noted, all references to Dark Horse
            CPAs include https://www.e3mortgage.com/. The Dark Horse CPAs
            website is a general informational site. By using the Dark Horse
            CPAs website, you consent to the data practices described in this
            statement. 
          </p>
          <h3>Collection of your Personal Information</h3>
          <p>
            In order to better provide you with products and services offered, E
            3 Mortgage may collect personally identifiable information, such as
            your: 
          </p>
          <p>
            - First and Last Name 
          ...
          <p>
            Dark Horse CPAs collects and uses your personal information to
            operate and deliver the services you have requested. 
          </p>
          <p>
            Dark Horse CPAs may also use your personally identifiable
            information to inform you of other products or services available
            from Dark Horse CPAs and its affiliates. 
          </p>
          <h3>Sharing Information with Third Parties</h3>
          <p>
            Dark Horse CPAs does not sell, rent or lease its customer lists to
            third parties. 
          </p>
          <p>
            Dark Horse CPAs may share data with trusted partners to help perform
            ...
            provide these services to Dark Horse CPAs and they are required to
            maintain the confidentiality of your information. 
          </p>
          <p>
            Dark Horse CPAs may disclose your personal information, without
            ...
            comply with legal process served on Dark Horse CPAs or the site; (b)
            protect and defend the rights or property of Dark Horse CPAs and/or
            (c) act under exigent circumstances to protect the personal safety
            of users of Dark Horse CPAs or the public. 
          </p>
          <h3>Automatically Collected Information</h3>
          <p>
            Information about your computer hardware and software may be
            automatically collected by Dark Horse CPAs This information can
            ...
            provide general statistics regarding use of the Dark Horse CPAs
            website. 
          </p>
          <h3>Use of Cookies</h3>
          <p>
            The Dark Horse CPAs website may use "cookies" to help you
          ...
          <p>
            ...
            you personalize Dark Horse CPAs pages, or register with Dark Horse
            CPAs site or services, a cookie helps Dark Horse CPAs to recall your
            ...
            same Props website, the information you previously provided can be
            retrieved, so you can easily use the Dark Horse CPAs features that
            you customized. 
          </p>
          <p>
            ...
            interactive features of the Dark Horse CPAs services or websites you
            visit. 
          </p>
          <h3>Links</h3>
          <p>
          ...
          <p>
            Dark Horse CPAs does not knowingly collect personally identifiable
          ...
          <p>
            From time to time, Dark Horse CPAs may contact you via email for the
            ...
            an email from Dark Horse CPAs or click on a link therein. 
          </p>
          <p>
            If you would like to stop receiving marketing or promotional
            communications via email from Dark Horse CPAs and Supply Co., you
            may opt out of such communications by clicking on the UNSUBSCRIBE
            button. 
          </p>
          <h3>Changes to this Statement</h3>
          <p>
            Dark Horse CPAs reserves the right to change this Privacy Policy
          ...
          <p>
            Dark Horse CPAs welcomes your questions or comments regarding this
            Statement of Privacy. If you believe that Dark Horse CPAs has not
